    ...
    bankrollInput("")
{
    ...
    startButton.setSize({ 300.f, 60.f });
    startButton.setPosition({ 350.f, 260.f });
    startButton.setFillColor(sf::Color(60, 60, 180));

    statsButton.setSize({ 300.f, 60.f });
    statsButton.setPosition({ 350.f, 360.f });
    statsButton.setFillColor(sf::Color(60, 180, 60));

    exitButton.setSize({ 300.f, 60.f });
    exitButton.setPosition({ 350.f, 460.f });
...
void MainMenu::handleMouseClick(sf::Vector2f mousePos, bool& startGame, bool& openStats, bool& exitGame)
{
    startGame = false;
    openStats = false;
    exitGame = false;
